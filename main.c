...
//  
//
//  Created by Amman on 06/11/2012.
//
//
//  Compiles with:
//
//  gcc -I/opt/local/include/ -o main_prog main.c -L/opt/local/lib/ -lopencv_core -lopencv_highgui -lopencv_video -lopencv_imgproc
//
//  assuming that macports is installed (and sudo install opencv is run)
//
//i have used the code in fback_c.c to help me to understand and implement the farneback algorithm (included with the opencv example folder)


//TODo externalise the print functions into a single function
//secure and release all memeory
//breif documentation
//possibly evidence of program working
//store previous frame name so can continue instead of over writing every time
